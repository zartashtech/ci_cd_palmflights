...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Start touring the city with Parliament Hill after you reach the city by booking any of FlightClick’s “cheap flights” to Ottawa.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                         <?php include "content/america/ottawa.php" ; ?>
