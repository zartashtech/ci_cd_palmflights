...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Want to have a feel of “terenga” the hospitality of Senegalese, then take the “cheap flights” to Dakar and enjoy your vacation.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                         <?php include 'content/africa/dakar.php'; ?>
