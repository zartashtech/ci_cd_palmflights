...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Lake Assal is the lowest point of Africa, so when in Africa you must see that. For seeing it, take the “cheap flights” to Djibouti.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php include 'content/africa/djibouti.php'; ?>
