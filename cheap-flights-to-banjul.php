...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="It has become a popular holiday destinations for the European visitors and for that you can go there by taking “cheap flights” to Banjul.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <?php include "content/europe/banjul.php" ; ?>
