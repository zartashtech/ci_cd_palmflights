...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="London is the capital of England and the United Kingdom. Book a “cheap flights” to view the London Eye observation wheel that provides panoramic views of the South Bank cultural complex and the entire city.">
   

   <?php //include'destination-header-meta.php';?>
</head>
