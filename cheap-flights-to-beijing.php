...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="You must see the seat of the Ming and the Qing dynasties of China and for that you need to take any of the “cheap flights” to Beijing.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php include "content/asia/beijing.php" ; ?>
