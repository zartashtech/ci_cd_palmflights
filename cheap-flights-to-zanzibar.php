...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Zanzibar is located on the island of Tanzania off the coast of East Africa. On its central island, Unguja, known as Zanzibar, is Stone Town, a historic commercial center with Swiss and Islamic influences. You can view former Sultan's Palace there. But for that you first need to take the “cheap flights” to Zanzibar from FlightClicks.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php
                        $desc = "SELECT * FROM places WHERE place_string='$dest'";
                        $que1 = mysqli_query($con, $desc);
                        $descrp = mysqli_fetch_array($que1);
                        if ($descrp['breif_desc'] != "") {
                            ?>

                            <h4>About <?php echo $descrp['city'] ?></h4>
                        <?php echo html_entity_decode($descrp['breif_desc']);
                        } ?>
