...
<body>
    ...
    <div class="global-wrap">
        ...
        <div class="container">
            ...
            <h3 class="booking-title">Flights For American Destinations</h3>
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    ...
                    <ul class="booking-list">
                        ...
                        $sql = "select DISTINCT city,img_url,destination_url from places where continent='America' and status='active'";
