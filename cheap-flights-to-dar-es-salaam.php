...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="You must see the Makumbusho Village Museum showcasing the houses constructed by various ethnic groups, by taking the “cheap flights” to Dar es Salaam.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                           <?php include 'content/africa/dar_es_salaam.php'; ?>
