...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Did you know that Shanghai was the largest and the most prosperous city in the 1930s. If you want to see that glorious city, then take the FlightClick’s offer of “cheap flights” to Shanghai.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <?php include "content/asia/shangai.php" ; ?>
