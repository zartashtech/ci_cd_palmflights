...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="You must go and do a BBQ with friends on the sandbank of the Congo River. Want to go there soon? Book the cheap flights to Kinshasa and go there.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                          <?php include 'content/africa/kinshasa.php'; ?>
