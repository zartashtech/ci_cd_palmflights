...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Zimbabwe’s staple food is Sadza made from corn meal. If you take “cheap flights” Harare, then you can enjoy this meal in the cafés in the capital city.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <?php include 'content/africa/harare.php'; ?>
