...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Fly to the White City of Chicago and spend a wonderful vacation there by booking FlightClick’s “cheap flights” to Chicago.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php include "content/america/chicago.php" ; ?>
