...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="You must visit the kangaroos when you are in Perth. But to take you Perth you must check the option of “cheap flights” to Perth.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                          <?php include "content/europe/perth.php" ; ?>
