...
$nameto = "Palm Flights";
$mailsubject = "Search Result Inquiry Via Callback Request";
...
try {
    ...
    $message .= "<tr><td><strong>Going To:</strong> </td><td id='custom_field_1'>" . $going_to . "</td></tr>";
    
    $message .= "<tr><td><strong>Departure Date:</strong> </td><td id='custom_field_13'>" . $departing_date . "</td></tr>";
    $message .= "<tr><td><strong>Return Date:</strong> </td><td id='custom_field_6'>" . $return_date . "</td></tr>";
    $message .= "<tr><td><strong>No of passenger:</strong> </td><td>" . $passenger . "</td></tr>";
