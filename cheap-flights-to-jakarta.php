...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content=" Pekan Raya Jakarta is an annual event held in Jakarta. You should not miss this event and you can go to Jakarta by booking the “cheap flights” to Jakarta.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <?php include "content/far-east/jakarta.php" ; ?>
