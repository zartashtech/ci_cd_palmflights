...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Never miss the great view of Calgary Tower and if have budget constraint, then also do not worry, book our “cheap flights” to Calgary.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <?php include "content/america/calgary.php" ; ?>
