...
*/
								...
								<li style="display:none;" ><span style="color: #01b7f2; font-size: 10px;" class="glyphicon glyphicon-time"> </span>
						...
						<br>
							...
							<a class="btn btn-primary primaryZ" href="tel:02070961696"> 02070961696</a>
                        ...
                        href="<?php echo strip_tags(htmlspecialchars("flight-search-landing-page-direct.php?
origin=$rows[origin]&destination=$rows[destination]&origin_city=NA&destination_city=$destination_city&trip_type=NA&totalFare=$rows[adult_fare]&class_name=Economy&duration=$rows[flight_duration]&airline_name=$rows[airline_name]&adults=1&child=0&infants=0&flight_route=NA&adult_fare=$rows[adult_fare]&child_fare=NA&infants_fare=$rows[infants_fare]&total_fare=$rows[adult_fare]&logo=$rows[airline_logo_medium]")); ?>">Book Now</a>
