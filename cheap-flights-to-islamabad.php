...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Taking a walk in the Margala hills and visiting Golra Sharif station are both great holiday experiences. For that you only need to book FlightClick’s “cheap flights” to Islamabad.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                         <?php include "content/asia/islamabad.php" ; ?>
