...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content=" Want to spend your holiday in the smallest independent state of Persian Gulf? Then don’t waste your time and book our “cheap flights” to Bahrain.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php include "content/asia/bahrain.php" ; ?>
