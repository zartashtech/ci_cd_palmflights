...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="You cannot miss the tryst with the pharaohs. To help you get there we have lots of “cheap flights” to Cairo.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php include 'content/africa/cairo.php'; ?>
