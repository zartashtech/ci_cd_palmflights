...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content=" Jairos Jiri Craftshop, a place for disabled people to sell crafts, is the best place to buy baskets. But for that you first need to take the “cheap flights” to Bulawayo from FlightClicks.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php include 'content/africa/bulawayo.php'; ?>
