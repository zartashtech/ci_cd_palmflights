        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="home">
                <form name="qq" class="form-horizontal" role="form" method="post" onsubmit="return check()" action="<?php echo strip_tags(htmlspecialchars("mailer-quote-mail.php")); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input name="query_form" type="hidden" class="form-control myht" value="Geta Quote through Search" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 main-glyph">
                            ...
                            <div class="row">
                                <div class="col-xs-5 col-md-5" style="margin-right:-20px;">
                                    <select class="form-control sele myht" id="sel2" name="country_code" required>
                                        <?php
                                        ...
                                        $sql1 = "SELECT * from country_code where country_code='$ip_country';";
                                        $result1 = mysqli_query($con, $sql1);
                                        $result = mysqli_query($con, $sql);
                                        $row1 = mysqli_fetch_array($result1);
                                        $ip_disp = $row1['disp_code'];
                                        $ip_actual = $row1['actual_code'];
                                        echo '<option value="' . $ip_actual . '">' . $ip_disp . '</option>';
                                        $num_results = mysqli_num_rows($result);
                                        for ($i = 0; $i < $num_results; $i++) {
                                            $row = mysqli_fetch_array($result);
                                            $disp_code = $row['disp_code'];
                                            $actual_code = $row['actual_code'];
                                            echo '<option value="' . $actual_code . '">' .  $disp_code . '</option>';
                                        }

                                        ?>
                                    </select><span class="glyphicon glyphicon-earphone"></span>
                                </div>




                                <div class="col-xs-1 col-md-1" style="margin-right:-20px;">-</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="leaving_date" class="form-control myht" type="text" placeholder="mm/dd/yy" id="date" min="<?php echo date("Y-m-d"); ?>" autocomplete="off" required />
                            <br />
            ...
            <div role="tabpanel" class="tab-pane" id="profile">
                ...
                <form class="form-horizontal" id="form2" role="form" method="POST" action="<?php echo strip_tags(htmlspecialchars("mailer-req-call-back.php")); ?>">
                    <div class="form-group">
                        <input name="query_form" type="hidden" class="form-control myht" value="Request Call Back through Search" />

                        <label class="control-label" style="text-align: left;">Full Name:</label>

                        <div class="main-glyph">
                            <input type="text" class="form-control myht" placeholder="Name" name="fname" minlength="3" maxlength="30" required />
                            <span class="glyphicon glyphicon-user"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="main-glyph">
                            <input type="email" class="form-control myht" placeholder="example@some.where" name="email" minlength="3" maxlength="50" required />
                            <span class="glyphicon glyphicon-envelope"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="main-glyph">
                            <input type="text" class="form-control myht" placeholder="Number" name="phoneNumber" minlength="7" maxlength="25" required />
                            <span class="glyphicon glyphicon-user"></span>
                        </div>
                        <!--sm5-->
                    </div>
                    <div class="form-group">
                        ...
                        <div class="main-glyph">
                            <input type="text" class="form-control myht" placeholder="city, specific airport, country" name="origin" minlength="3" maxlength="100" required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="main-glyph">
                            <input type="text" class="form-control myht" placeholder="city, specific airport, country" name="destination" minlength="3" maxlength="100" required />
                            <span class="glyphicon glyphicon-map-marker"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="main-glyph">
                            <input name="departing_date" class="form-control myht date" id="date" type="text" placeholder="dd/mm/yy" min="<?php echo date("Y-m-d"); ?>" autocomplete="off" required />
