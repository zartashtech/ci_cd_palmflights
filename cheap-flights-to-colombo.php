...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="While in Sri Lanka, you must see the Sapumal Foundation where you can see the development of art in Sri Lanka. For that you need to take the “cheap flights” to Colombo.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php include "content/asia/colombo.php" ; ?>
