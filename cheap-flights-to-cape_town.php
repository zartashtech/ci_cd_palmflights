...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="A must visit place is the wine lands around Cape Town. Plan to go there this vacation by taking one of the “cheap flights” to Cape Town.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <?php include 'content/africa/cape_town.php'; ?>
