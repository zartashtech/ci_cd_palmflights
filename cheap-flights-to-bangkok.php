...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="When in Bangkok never miss Wat Pho, the largest reclining Buddha image. You can get to Bangkok easily and in a modest budget with FlightClick’s “cheap flights” to Bangkok.">
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <?php include "content/far-east/bangkok.php" ; ?>
